...
export class AppComponent extends AppComponentBase implements OnInit {
    ...
    @ViewChild('linkedAccountsModal')
    linkedAccountsModal: LinkedAccountsModalComponent;
    @ViewChild('userDelegationsModal', { static: true })
    userDelegationsModal: UserDelegationsModalComponent;
    ...
    ngOnInit(): void {
        $.getScript(
            'assets/template/layout_1/RTL/default/full/assets/js/app.js'
        );
