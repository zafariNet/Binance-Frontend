...
enabledSocialLoginSettingsLoaded:boolean=false;
    ...
    constructor(
        ...
        super(injector);
        this._pageTitleService.pageTitle = 'Settings';
        this._pageTitleService.pageDescription = 'SettingsHeaderInfo';
    }
    ...
    loadSocialLoginSettings(): void {
        ...
        this._hostSettingService.getEnabledSocialLoginSettings()
            .subscribe(setting => {
                ...
                self.enabledSocialLoginSettingsLoaded=true;
            });
    }
}
